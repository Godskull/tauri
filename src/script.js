...
function generateColor () {
  let h = Math.random() * 240; // Generate a random hue between 0 (red) and 240 (blue)
  let s = 0.50; // Keep saturation at maximum
  let l = 0.15; // Keep lightness in the middle
  let c = HSLtoRGB(h, s, l); // Convert HSL to RGB
  return c;
}
...
function generateColor () {
  let hue = (Math.random() * (300 - 240) + 240) / 360;
